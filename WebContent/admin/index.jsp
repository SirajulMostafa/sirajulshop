...
<meta
	...
	name="viewport">
<!-- Bootstrap 3.3.5 -->
<%@ include file="../admin_css_link.jsp"%>

<!--/ Bootstrap 3.3.5  for admin -->
...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="../../index2.html" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
				<span class="logo-mini"><b>SM</b>S</span> <!-- logo for regular state and mobile devices -->
				<span class="logo-lg"><b>Sirajul's</b>&ndash; Shop</span>
			</a>
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown user user-menu"><a href="#"
							class="dropdown-toggle" data-toggle="dropdown"> <img
								src="../adminLTE/img/user2-160x160.jpg" class="user-image"
								alt="User Image"> <span class="hidden-xs"><c:out
										value="${sessionScope['loginUser']}" /></span>
						</a>
							<ul class="dropdown-menu">
								<!-- User image -->
								<li class="user-header"><img
									src="../adminLTE/img/user2-160x160.jpg" class="img-circle"
									alt="User Image">
									<p>
								...
								<li class="user-footer">
									...
									<div class="pull-right">
										<a href="../logout.jsp" class="btn btn-default btn-flat">Sign
											out </a>
									</div>
								</li>
							</ul></li>
				...
				<ul class="sidebar-menu">
					...
					<li class="treeview"><a href="#"><i
						...
						<ul class="treeview-menu">
							<li><a href="../../index.html"><i class="fa fa-circle-o"></i>Dashboard
									v1</a></li>
							...
							<li><a href="index.jsp?add=shop_items_add"><i
									class="fa fa-circle-o text-green"></i> Add Category</a></li>
	...
	<script type="text/javascript"
		src="../adminLTE/plugins/jQuery/jQuery-2.1.4.min.js"></script>
	<!-- Bootstrap 3.3.5 -->
	<script type="text/javascript"
		src="../adminLTE/bootstrap/js/bootstrap.min.js"></script>

	<!-- DataTables -->
	<script type="text/javascript"
		src="../adminLTE/plugins/datatables/jquery.dataTables.min.js"></script>
	<script type="text/javascript"
		src="../adminLTE/plugins/datatables/dataTables.bootstrap.min.js"></script>
	...
	<!-- FastClick -->
	<script type="text/javascript"
		src="../adminLTE/plugins/fastclick/fastclick.min.js"></script>
	<!-- Sirajul's Shoop App -->
	<script type="text/javascript" src="../adminLTE/js/app.min.js"></script>
