	...
	<div class="box box-warning">
		...
		<div class="box-body">
			<form action="options/manage_shop_items/shop_items_mdl/edit.jsp"
				...
				<div class="form-group col-md-6">
					<label for="brand">Barnd</label> <select
				...
				<div class="form-group col-md-6">
					<label for="shop_category_id">Category(optional)</label> 
					<select id="shop_category_id" name="shop_category_id"
						class="form-control ">
				...
				<input type="hidden"  id="product_id" name="product_id"value="${param_id}">
				<input type="hidden"  id="prod_brand_cat_id" name="prod_brand_cat_id"value="${prod_brand_cat_id}">
