...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
    ...
    <link href="Theme/plugins/selectbox/select_option1.css" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="Theme/plugins/rs-plugin/css/settings.css" media="screen">
    <link rel="stylesheet" type="text/css" href="Theme/plugins/owl-carousel/owl.carousel.css" media="screen">
    ...
    <link rel="stylesheet" href="Theme/css/default.css" id="option_color">
  ...
  <body class="body-wrapper">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                      ...
                      <li>
                        <a href="single-product.html">
                          <div class="media">
                            <img class="media-left media-object" src="Theme/img/home/cart-items/cart-item-01.jpg" alt="cart-Image">
        ...
        <nav class="navbar navbar-main navbar-default" role="navigation">
          <div class="container">
            ...
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="index-2.html"><img src="Theme/img/logo.png" alt="logo"></a>
            </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown megaDropMenu">
                  ...
                  <ul class="dropdown-menu row">
                    ...
                    <li class="col-sm-3 col-xs-12">
                      <a href="#" class="menu-photo"><img src="Theme/img/menu-photo.jpg" alt="menu-img"></a>
                    </li>
                  </ul>
                </li>
                <li class="dropdown">
          ...
          <div class="fullscreenbanner">
            <ul>
              <li data-transition="slidehorizontal" data-slotamount="5" data-masterspeed="700" data-title="Slide 1">
                <img src="Theme/img/home/banner-slider/slider-bg.jpg" alt="slidebg1" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat">
                <div class="slider-caption slider-captionV1 container">
                  ...
                  <div class="tp-caption rs-caption-1 sft start"
                    ...
                    data-endspeed="300" >
                    <img src="Theme/img/home/banner-slider/shoe1.png" alt="slider-image" style="width: 781px; height: 416px;">
                  </div>
              ...
              <li data-transition="slidehorizontal" data-slotamount="5" data-masterspeed="1000" data-title="Slide 2">
                <img src="Theme/img/home/banner-slider/slider-bg.jpg" alt="slidebg" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat">
                <div class="slider-caption slider-captionV1 container captionCenter">
                  <div class="tp-caption rs-caption-1 sft start text-center"
                    ...
                    data-easing="Back.easeInOut"
                    data-endspeed="300">
                    <img src="Theme/img/home/banner-slider/shoe2.png" alt="slider-image">
                  </div>
              ...
              <li data-transition="slidehorizontal" data-slotamount="5" data-masterspeed="700"  data-title="Slide 3">
                ...
                <div class="slider-caption slider-captionV1 container">
                  <div class="tp-caption rs-caption-1 sft start"
                    ...
                    data-easing="Back.easeInOut"
                    data-endspeed="300">
                    <img src="Theme/img/home/banner-slider/shoe3.png" alt="slider-image">
                  </div>
              ...
              <div class="owl-carousel featuredProductsSlider">
                <div class="slide">
                  <div class="productImage clearfix">
                    <img src="Theme/img/home/featured-product/product-01.jpg" alt="featured-product-img">
                ...
                <div class="slide">
                  <div class="productImage">
                    <img src="Theme/img/home/featured-product/product-02.jpg" alt="featured-product-img">
                    <div class="productMasking">
                      <ul class="list-inline btn-group" role="group">
                        <li><a data-toggle="modal" href=".html" class="btn btn-default"><i class="fa fa-heart"></i></a></li>
                        <li><a href="cart-page.html" class="btn btn-default"><i class="fa fa-shopping-cart"></i></a></li>
                ...
                <div class="slide">
                  <div class="productImage">
                    <img src="Theme/img/home/featured-product/product-03.jpg" alt="featured-product-img">
                    <div class="productMasking">
                      <ul class="list-inline btn-group" role="group">
                        <li><a data-toggle="modal" href=".html" class="btn btn-default"><i class="fa fa-heart"></i></a></li>
                        <li><a href="cart-page.html" class="btn btn-default"><i class="fa fa-shopping-cart"></i></a></li>
                ...
                <div class="slide">
                  <div class="productImage">
                    <img src="Theme/img/home/featured-product/product-04.jpg" alt="featured-product-img">
                    <div class="productMasking">
                      <ul class="list-inline btn-group" role="group">
                        <li><a data-toggle="modal" href=".html" class="btn btn-default"><i class="fa fa-heart"></i></a></li>
                        <li><a href="cart-page.html" class="btn btn-default"><i class="fa fa-shopping-cart"></i></a></li>
                ...
                <div class="slide">
                  <div class="productImage">
                    <img src="Theme/img/home/featured-product/product-05.jpg" alt="featured-product-img">
                    <div class="productMasking">
                      <ul class="list-inline btn-group" role="group">
                        <li><a data-toggle="modal" href=".html" class="btn btn-default"><i class="fa fa-heart"></i></a></li>
                        <li><a href="cart-page.html" class="btn btn-default"><i class="fa fa-shopping-cart"></i></a></li>
                ...
                <div class="slide">
                  <div class="productImage">
                    <img src="Theme/img/home/featured-product/product-06.jpg" alt="featured-product-img">
                    <div class="productMasking">
                      <ul class="list-inline btn-group" role="group">
                        <li><a data-toggle="modal" href=".html" class="btn btn-default"><i class="fa fa-heart"></i></a></li>
                        <li><a href="cart-page.html" class="btn btn-default"><i class="fa fa-shopping-cart"></i></a></li>
                ...
                <div class="slide">
                  <div class="productImage">
                    <img src="Theme/img/home/featured-product/product-07.jpg" alt="featured-product-img">
                    <div class="productMasking">
                      <ul class="list-inline btn-group" role="group">
                        <li><a data-toggle="modal" href=".html" class="btn btn-default"><i class="fa fa-heart"></i></a></li>
                        <li><a href="cart-page.html" class="btn btn-default"><i class="fa fa-shopping-cart"></i></a></li>
                ...
                <div class="slide">
                  <div class="productImage">
                    <img src="Theme/img/home/featured-product/product-09.jpg" alt="featured-product-img">
                    <div class="productMasking">
                      <ul class="list-inline btn-group" role="group">
                        <li><a data-toggle="modal" href=".html" class="btn btn-default"><i class="fa fa-heart"></i></a></li>
                        <li><a href="cart-page.html" class="btn btn-default"><i class="fa fa-shopping-cart"></i></a></li>
          ...
          <div class="row latestArticles">
            ...
            <div class="col-sm-3 col-xs-12">
              <div class="thumbnail">
                ...
                <a href="blog-single-right-sidebar.html"><img src="Theme/img/home/articles/articles-01.jpg" alt="article-image"></a>
                <div class="caption">
            ...
            <div class="col-sm-3 col-xs-12">
              <div class="thumbnail">
                ...
                <span class="meta">July 16, 2016 by <a href="#">Abdus</a></span>
                <a href="blog-single-right-sidebar.html"><img src="Theme/img/home/articles/articles-02.jpg" alt="article-image"></a>
                <div class="caption">
            ...
            <div class="col-sm-3 col-xs-12">
              <div class="thumbnail">
                ...
                <span class="meta">July 16, 2016 by <a href="#">Abdus</a></span>
                <a href="blog-single-right-sidebar.html"><img src="Theme/img/home/articles/articles-03.jpg" alt="article-image"></a>
                <div class="caption">
            ...
            <div class="col-sm-3 col-xs-12">
              <div class="thumbnail">
                ...
                <span class="meta">July 16, 2016 by <a href="#">Abdus</a></span>
                <a href="blog-single-right-sidebar.html"><img src="Theme/img/home/articles/articles-04.jpg" alt="article-image"></a>
                <div class="caption">
              ...
              <div class="owl-carousel partnersLogoSlider">
                <div class="slide">
                  <div class="partnersLogo clearfix">
                    <img src="Theme/img/home/partners/partner-01.png" alt="partner-img">
                  </div>
                </div>
                <div class="slide">
                  <div class="partnersLogo clearfix">
                    <img src="Theme/img/home/partners/partner-02.png" alt="partner-img">
                  </div>
                </div>
                <div class="slide">
                  <div class="partnersLogo clearfix">
                    <img src="Theme/img/home/partners/partner-03.png" alt="partner-img">
                  </div>
                </div>
                <div class="slide">
                  <div class="partnersLogo clearfix">
                    <img src="Theme/img/home/partners/partner-04.png" alt="partner-img">
                  </div>
                </div>
                <div class="slide">
                  <div class="partnersLogo clearfix">
                    <img src="Theme/img/home/partners/partner-05.png" alt="partner-img">
                  </div>
                </div>
                <div class="slide">
                  <div class="partnersLogo clearfix">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-5 col-xs-12">
              <ul class="list-inline">
                <li><img src="Theme/img/home/footer/card1.png"></li>
                <li><img src="Theme/img/home/footer/card2.png"></li>
                <li><img src="Theme/img/home/footer/card3.png"></li>
                <li><img src="Theme/img/home/footer/card4.png"></li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div class="modal-body">
            ...
            <div class="media">
              <div class="media-left">
                <img class="media-object" src="Theme/img/products/quick-view/quick-view-01.jpg" alt="Image">
              </div>
              <div class="media-body">
    ...
    <script src="Theme/plugins/selectbox/jquery.selectbox-0.1.3.min.js"></script>
    <script src="Theme/plugins/countdown/jquery.syotimer.js"></script>
    <script src="Theme/js/custom.js"></script>

  <link href="Theme/options/optionswitch.css" rel="stylesheet">
<script src="Theme/options/optionswitcher.js"></script>
</body>
