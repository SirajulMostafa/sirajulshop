			...
			<div class="container">
				...
				<div class="collapse navbar-collapse navbar-ex1-collapse">
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown megaDropMenu"><a
							href="javascript:void(0)" class="dropdown-toggle"
							data-toggle="dropdown" data-hover="dropdown" data-delay="300"
							data-close-others="true" aria-expanded="false">Shop</b></a>
							<ul class="dropdown-menu row">
								<li class="col-sm-3 col-xs-12">
									<ul class="list-unstyled">
										...
										<li><a href="product-grid-right-sidebar.html">Products
												Sidebar Right</a></li>
										<li><a href="product-grid-3-col-filter.html">Products
												3 Columns V1</a></li>
								...
								<li class="col-sm-3 col-xs-12"><a href="#"
									class="menu-photo"><img src="Theme/img/menu-photo.jpg"
										alt="menu-img"></a></li>
							</ul></li>
						<li class="dropdown"><a href="javascript:void(0)"
							class="dropdown-toggle" data-toggle="dropdown" role="button"
						...
						<li class="dropdown"><a href="javascript:void(0)"
							...
							<ul class="dropdown-menu dropdown-menu-right">
								...
								<li><a href="blog-single-right-sidebar.html">Single
										Right Sidebar</a></li>
						...
						<li class="dropdown"><a href="javascript:void(0)"
							...
							<ul class="dropdown-menu dropdown-menu-right">
								...
								<li><a href="tooltip-pagination.html">Tooltip
										Pagination</a></li>
